...
const.UNIT_FRAME_ANCHOR_TARGETS = {
    const.UNIT_FRAME_ANCHOR.SCREEN_CENTER,
    const.UNIT_FRAME_ANCHOR.PLAYER_FRAME,
    const.UNIT_FRAME_ANCHOR.TARGET_FRAME,
    const.UNIT_FRAME_ANCHOR.FOCUS_FRAME,
    const.UNIT_FRAME_ANCHOR.ESSENTIAL_CDS,
    const.UNIT_FRAME_ANCHOR.CUSTOM_FRAME,
}
